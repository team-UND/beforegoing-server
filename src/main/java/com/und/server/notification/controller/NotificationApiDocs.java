		...
		@ApiResponse(
			...
			content = @Content(
				...
				examples = @ExampleObject(
					...
					value = "{\"code\":\"CACHE_FETCH_ALL_FAILED\", \"message\":\"Failed to fetch all scenarios notification cache\"}"
				)
			)
		)
	})
		...
		@ApiResponse(
			...
			content = @Content(
				...
				examples = @ExampleObject(
					...
					value = "{\"code\":\"CACHE_NOT_FOUND_SCENARIO_NOTIFICATION\", \"message\":\"Not found scenario notification cache\"}"
				)
			)
		),
		@ApiResponse(
			...
			content = @Content(
				...
				examples = @ExampleObject(
					name = "Cache fetch failed",
					value = "{\"code\":\"CACHE_FETCH_SINGLE_FAILED\", \"message\":\"Failed to fetch single scenario notification cache\"}"
				)
			)
		)
	})

					...
					content = @Content(
							...
							examples = {
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_MISSION_FOUND_DATE",
											  "message": "Mission can only be founded for mission dates"
											}
											"""
								)
							}
							...
							examples = {
								...
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "Content must be at most 10 characters"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_TODAY_MISSION_DATE",
											  "message": "Today mission can only be added for today or future dates"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "MAX_MISSION_COUNT_EXCEEDED",
											  "message": "Maximum mission count exceeded"
											}
											"""
								)
							}

										...
										value = """
											{
											  ...
											  "message": "Unsupported mission type"
											}
											"""
								)
							}
							...
							examples = {
								...
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "Scenario name must be at most 10 characters"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "Memo must be at most 15 characters"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "Basic mission content must not be blank"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "Basic mission content must be at most 50 characters"
											}
											"""
								),
								@ExampleObject(
								...
								@ExampleObject(
										...
										value = """
											{
											  "code": "MAX_SCENARIO_COUNT_EXCEEDED",
											  "message": "Maximum scenario count exceeded"
											}
											"""
								)
							}
							...
							examples = {
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "PrevOrder must be greater than or equal to 1"
											}
											"""
								),
								@ExampleObject(
										...
										value = """
											{
											  "code": "INVALID_PARAMETER",
											  "message": "NextOrder must be greater than or equal to 1"
											}
											"""
								)
							}
